...
public class InventoryEditor extends AppCompatActivity {
    ...
    private void insertProduct() {
        ...
        if (rowId == -1) {
            Toast.makeText(this, "Error saving product entry", Toast.LENGTH_SHORT).show();
        } else {
            Toast.makeText(this, "Product successfully added with id: " + rowId, Toast.LENGTH_SHORT).show();
        }
    }
